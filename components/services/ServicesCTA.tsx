    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-6">
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-10 py-5 rounded-full font-bold text-lg text-white bg-[#E8820C] hover:bg-[#C96B00] transition-colors duration-200 hover:scale-105 active:scale-95"
            style={{ boxShadow: "0 12px 32px rgba(232,130,12,0.30)" }}
          >
            Request a Quote
          </a>
          <a
