  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-xl mt-4" style={{ color: "#6B7280" }}>
          Tell us your OCC grade, quantity, and destination port. We&apos;ll handle
          everything else.
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-6">
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-10 py-5 rounded-full font-bold text-lg text-white transition-all duration-200 hover:scale-105 active:scale-95"
            style={{
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2.5 px-10 py-5 rounded-full font-bold text-lg text-white transition-all duration-200 hover:scale-105 active:scale-95"
