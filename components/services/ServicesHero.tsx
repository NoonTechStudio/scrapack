    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 md:py-24 text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-4 rounded-full font-bold text-lg text-white transition-all duration-200 hover:scale-105"
            style={{
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full font-bold text-lg text-white transition-all duration-200 hover:scale-105"
