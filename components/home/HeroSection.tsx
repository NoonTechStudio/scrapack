...
export default function HeroSection() {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #fefefe 0%, #fdf8f0 30%, #f0f7f0 60%, #fefcf7 100%)",
      }}
    >
      ...
      <div className="md:hidden flex items-center justify-between px-5 pt-4 pb-2 relative z-20">
        ...
        <a
          ...
          className="flex items-center gap-2 bg-green-500 text-white text-xs font-semibold px-3 py-2 rounded-full shadow-md"
        >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-6 md:px-12 lg:px-20 pt-6 pb-16 md:pt-28 md:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-[60%_40%] gap-12 lg:gap-8 items-center">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:flex sm:flex-wrap sm:gap-8 mb-8">
              {[
                ...
                <div key={label}>
                  <p className="text-[10px] sm:text-xs font-medium tracking-wide text-gray-400 mb-0.5 uppercase">
                    {label}
                  </p>
                  <p className="font-bold text-xs sm:text-sm" style={{ color: "#1A2E1A" }}>
                    {value}
                  </p>
                </div>
              ))}
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
              <a
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 rounded-full font-bold text-lg text-white transition-all duration-200 hover:scale-105 active:scale-95 hover:bg-amber-600 w-full sm:w-auto"
                style={{
              ...
              <a
                href="#grades"
                className="inline-flex items-center justify-center px-8 py-4 rounded-full font-semibold text-lg border-2 transition-all duration-200 hover:bg-[#1A2E1A] hover:text-white w-full sm:w-auto"
          ...
          <div className="hidden lg:flex items-center justify-center relative h-[520px]">
            {/* Main grade card */}
            <div
              className="absolute bg-white rounded-3xl p-8 w-72 shadow-2xl border border-gray-100 z-10"
            ...
            >
              ...
              <p className="text-xs mt-0.5 text-amber-100">All Major Ports</p>
            </div>
