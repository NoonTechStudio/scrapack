...
export default function CTASection() {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(135deg, #fdf8f0, #f0f7f0)",
      }}
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 mb-12 reveal reveal-delay-3">
          <a
            href="/contact"
            className="inline-flex items-center justify-center px-10 py-5 rounded-full font-bold text-lg text-white transition-all duration-200 hover:scale-105 active:scale-95 hover:bg-amber-600 w-full sm:w-auto"
            style={{
              backgroundColor: "#F59E0B",
              boxShadow: "0 12px 32px rgba(245,158,11,0.30)",
            }}
          >
            Request a Quote
          </a>
          <a
            ...
            style={{
              ...
              boxShadow: "0 12px 32px rgba(26,46,26,0.20)",
            }}
          >
            <svg
              width="20"
        ...
        <div
          ...
          style={{ color: "#9CA3AF" }}
        >
          <span>📍 9830 Walley Ave, Philadelphia, PA 19115</span>
          <a
            href="mailto:info@scrapacksolutions.com"
            className="hover:text-gray-600 transition-colors"
          >
            ✉️ info@scrapacksolutions.com
          </a>
        </div>
      </div>
    </section>
